...
const RestaurantMenu = () => {
    ...
    return !menu || !resCart.name ?
        (<section className="flex h-screen  justify-center items-center flex-col w-full pt-[120px]">
            <img className="rounded-full w-56 md:w-[400px]" src={"/assets/data-not-found.avif"} />
            <h3 className="text-2xl md:text-4xl font-bold mt-5  text-gray-100 text-center">Restaurant Details Not Found.</h3>
