        ...
        <Link onClick={() => {handleScrollTop()}} className="hover:scale-95 transition-all duration-300" to={"/restaurant/" + info.id}>
            <div className=" w-[270px] md:w-80 p-2 min-h-[280px]">
                ...
                <div className="w-full px-4 mt-2">
                    <h3 className="text-base lg:text-lg font-semibold text-gray-100 truncate">{info?.name}</h3>
                    ...
                    <p className="mt-1 truncate text-sm lg:text-base font-light text-gray-300">{info?.cuisines?.join(", ")}</p>
                    <p className=" truncate font-light text-sm lg:text-base text-gray-300">{info?.areaName}</p>
