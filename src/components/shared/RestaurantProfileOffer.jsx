            ...
            <div className="w-full mt-10">
                <div className="flex justify-between items-center pb-4">
                    <div>
                        ...
                        <p className="font-light text-gray-600 mt-2 text-sm">{cuisines.join(", ")}</p>
                        <p className="font-light text-gray-600 text-sm">{areaName}, {sla?.lastMileTravelString}</p>
                    </div>
                    <div>
                ...
                <div className="border-t  border-dashed border-gray-400 pt-4">
                    <ul className="flex gap-4 items-center *:font-bold *:text-gray-700">
